...
; Because now we have a tree recursion instead of linear recursion. Tree recursion increases exponentially with 
; the depth of the tree and that is which is log n.